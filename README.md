...
Dissect, Anatomize and Enrich (+ info, ideas, context...) pieces of cryptomedia.

![alt text](https://github.com/math77/longhouse/blob/main/assets/ibis.png?raw=true)
...
Actually, signals, because there are two:
- I'm looking for a sponsorship of 2.4 ETH so that I can buy a new laptop/setup (the current one is very old and limits me a bit) and also go full-time on this project and on crypto in general.
...
![alt text](https://github.com/math77/longhouse/blob/main/assets/scheme-dissect.png?raw=true)
...
![alt text](https://github.com/math77/longhouse/blob/main/assets/scheme-anatomize.png?raw=true)
...
![alt text](https://github.com/math77/longhouse/blob/main/assets/scheme-enrich.png?raw=true)
...
![alt text](https://github.com/math77/longhouse/blob/main/assets/inspiration.jpg?raw=true)
